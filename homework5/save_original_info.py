...
def save_func_info(source_func):
    def wrapper(like_wrapped_func):
        like_wrapped_func.__doc__ = source_func.__doc__
        like_wrapped_func.__name__ = source_func.__name__
        like_wrapped_func.__original_func = source_func
        return like_wrapped_func
    return wrapper
